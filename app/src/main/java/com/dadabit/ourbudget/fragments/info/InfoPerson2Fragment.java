...
public class InfoPerson2Fragment  extends Fragment {
    ...
    public static Fragment newInstance(){
        InfoPerson2Fragment fragment = new InfoPerson2Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_info_person2, container, false);

        cardIncomeMonth = (CardView) view.findViewById(R.id.info_p2_card_month_earnings);
        cardIncomeTotal = (CardView) view.findViewById(R.id.info_p2_card_total_earnings);
        cardSpendMonth = (CardView) view.findViewById(R.id.info_p2_card_month);
        cardSpendToday = (CardView) view.findViewById(R.id.info_p2_card_today);
        cardSpendTotal = (CardView) view.findViewById(R.id.info_p2_card_total);
        cardTransactionsMonth = (CardView) view.findViewById(R.id.info_p2_card_month_transactions);
        cardTransactionsTotal = (CardView) view.findViewById(R.id.info_p2_card_total_transactions);

        tvIncomeMonth = (TextView) view.findViewById(R.id.info_p2_month_earnings_value);
        tvIncomeTotal = (TextView) view.findViewById(R.id.info_p2_total_earnings_value);
        tvSpendMonth = (TextView) view.findViewById(R.id.info_p2_month_value);
        tvSpendToday = (TextView) view.findViewById(R.id.info_p2_today_value);
        tvSpendTotal = (TextView) view.findViewById(R.id.info_p2_total_value);
        tvTransactionsMonth = (TextView) view.findViewById(R.id.info_p2_month_transactions_value);
        tvTransactionsTotal = (TextView) view.findViewById(R.id.info_p2_total_transactions_value);
    ...
    private class GetDataAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            Cursor cursor = db.getPerson2Transactions();
